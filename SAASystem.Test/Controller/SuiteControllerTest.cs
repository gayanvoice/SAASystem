...
{
    /// <summary>
    /// SuiteControllerTest.cs executes the tests to check if each action returns view
    public class SuiteControllerTest
    {
        private readonly SuiteController _controller;

        public SuiteControllerTest()
        {
            _controller = new SuiteController();
        }
