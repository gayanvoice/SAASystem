...
namespace SAASystem.Controllers
{
    public class HomeController : Controller
    {
        ...
        public UserViewModel.ListViewModel List()
        {
            UserViewModel.ListViewModel indexViewModel = new UserViewModel.ListViewModel();
            indexViewModel.UserContextModelEnumerable = _userContext.SelectAll();
