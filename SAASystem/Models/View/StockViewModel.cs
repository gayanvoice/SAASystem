...
namespace SAASystem.Models.View
{
    public class StockViewModel
    {
        ...
        public class ShowViewModel
        {
            ...
            public class FormViewModel
            {
                    ...
                    StockContextModel contextModel)
                {
                    ...
                    formViewModel.StockId = contextModel.StockId;
        ...
        {
            public string Status { get; set; }
            public IEnumerable<StockContextModel> StockContextModelEnumerable { get; set; }
        }
        public class DeleteViewModel
        {
            public StockContextModel StockContextModel { get; set; }
        }
